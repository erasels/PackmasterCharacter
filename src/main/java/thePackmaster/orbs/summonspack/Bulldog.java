...
public class Bulldog extends CustomOrb {
    ...
    private static final float DOG_WIDTH = 96.0f;
    ...
    public void onEvoke() {
        ...
        Wiz.doDmg(m, passiveAmount, DamageInfo.DamageType.THORNS);
    }
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(img, cX - DOG_WIDTH /2F, cY - DOG_WIDTH /2F, DOG_WIDTH /2F, DOG_WIDTH /2F,
                DOG_WIDTH, DOG_WIDTH, scale, scale, rotation, 0, 0, (int) DOG_WIDTH, (int) DOG_WIDTH,
                false, false);
        renderText(sb);
        hb.render(sb);
    }
