...
package thePackmaster.vfx.sentinelpack;
...
public class AngryParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public AngryParticleEffect() {
        this.img = ImageMaster.GLOW_SPARK;
        this.duration = MathUtils.random(1F, 1.3F);
        this.scale = MathUtils.random(0.3F, .6F) * Settings.scale;
        this.dur_div2 = this.duration / 2.0F;
        this.color = new Color(MathUtils.random(0.5F, 1.0F), 0.35F, MathUtils.random(0.2F, 0.4F), 0.0F);
