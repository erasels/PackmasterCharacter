...
public class EssenceGraspParticleEffect extends AbstractGameEffect {
    ...
    public EssenceGraspParticleEffect(float sX, float sY, float tX, float tY, boolean facingLeft) {
