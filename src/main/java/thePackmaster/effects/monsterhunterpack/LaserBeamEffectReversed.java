...
public class LaserBeamEffectReversed extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public LaserBeamEffectReversed(float x, float y) {
        if (img == null) {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(img, this.x, this.y - (float)(img.packedHeight / 2), 0.0F, (float)img.packedHeight / 2.0F, (float)img.packedWidth, (float)img.packedHeight, -1 * (this.scale * 2.0F + MathUtils.random(-0.05F, 0.05F)), this.scale * 20F + MathUtils.random(-0.1F, 0.1F), MathUtils.random(186.0F, 189.0F));
        sb.draw(img, this.x, this.y - (float)(img.packedHeight / 2), 0.0F, (float)img.packedHeight / 2.0F, (float)img.packedWidth, (float)img.packedHeight, -1 * (this.scale * 2.0F + MathUtils.random(-0.05F, 0.05F)), this.scale * 20F + MathUtils.random(-0.1F, 0.1F), MathUtils.random(186.0F, 189.0F));
