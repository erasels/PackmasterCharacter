package thePackmaster.stances.foxpack;
...
import thePackmaster.effects.monsterhunterpack.PlayfulAura;
...
public class PlayfulStance extends AbstractUseCardStance {
    public static final String STANCE_ID = makeID("Playful");
    private static long sfxId = -1L;

    public PlayfulStance() {
        this.ID = STANCE_ID;
    ...
    public void updateAnimation() {
        ...
        if (this.particleTimer2 < 0.0F) {
            ...
            AbstractDungeon.effectsQueue.add(new PlayfulAura());
        }
    }
