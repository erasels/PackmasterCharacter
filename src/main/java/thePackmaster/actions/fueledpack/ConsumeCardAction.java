...
public class ConsumeCardAction extends AbstractGameAction {
    private static final String ID = SpireAnniversary5Mod.makeID(ConsumeCardAction.class.getSimpleName());
    ...
    public ConsumeCardAction() {
        this(1);
    }

    public ConsumeCardAction(int amount) {
        this(amount, amount > 1);
    }

    public ConsumeCardAction(int amount, boolean anyNumber) {
        this(amount, anyNumber, null);
    }

    public ConsumeCardAction(int amount, boolean anyNumber, BiConsumer<AbstractCard, AbstractCard> followup) {
        this(amount, anyNumber, followup, null);
    }

    public ConsumeCardAction(int amount, boolean anyNumber, BiConsumer<AbstractCard, AbstractCard> followup, Function<AbstractCard, Boolean> conditions) {
        this(amount, anyNumber, followup, conditions, 0);
    }

    public ConsumeCardAction(int amount, boolean anyNumber, BiConsumer<AbstractCard, AbstractCard> followup, Function<AbstractCard, Boolean> conditions, int rarityModifier) {
        cards = amount;
    ...
    public ConsumeCardAction(boolean anyNumber) {
        this(anyNumber ? 99 : 1, anyNumber);
    }

    public ConsumeCardAction(BiConsumer<AbstractCard, AbstractCard> followup) {
        this(1, false, followup);
    }

    public ConsumeCardAction(Function<AbstractCard, Boolean> conditions) {
        this(1, false, null, conditions);
    }

    public ConsumeCardAction(AbstractCard playedCard) {
        this();
