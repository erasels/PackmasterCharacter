...
public class StarShower extends AbstractPackmasterCard {
    ...
    public StarShower() {
        super(ID, 0, CardType.ATTACK, CardRarity.COMMON, CardTarget.ENEMY, ThePackmaster.Enums.PACKMASTER_RAINBOW);
